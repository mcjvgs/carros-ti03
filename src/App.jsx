    ...
    <main>
      <section>
        <div className="bg-orange">
          ...
          <p className="font-lexend">Escolha um sedan pelo seu preço acessível e excelente
        ...
        <div className="bg-green">
          ...
          <p className="font-lexend">Escolha um SUV pelo seu interior espaçoso, 
        ...
        <div className="bg-dark-green">
          ...
          <p className="font-lexend">Passeie nos melhores carros sem os
