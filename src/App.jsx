    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <p className="font-lexend mb-7 text-offwhite">Escolha um sedan pelo seu preço acessível e excelente
        ...
        <div className="bg-green p-12">
          ...
          <p className="font-lexend mb-7 text-offwhite">Escolha um SUV pelo seu interior espaçoso, 
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <p className="font-lexend mb-7 text-offwhite">Passeie nos melhores carros sem os
